...
//const MODEL_DATA_URL ='https://github.com/alexking-byte/openwork/blob/main/model.json';
      ...
      <div className="wrap">
        ...
        <div style={{ margin: "1rem 0" }}>
          <div className="type-row">
            <span className="type-row-left">種類</span>
            <span className="type-row-right">確率</span>
          </div>
          {!!predictRes.length &&
