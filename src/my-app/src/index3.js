...
if(window.File && window.FileReader && window.FileList && window.Blob) {
 async function loadLocalImage(e) {
    ...
    console.log("img uploaded...");
     ...
     // result.innerHTML=fileData;
      console.log("test 1 file:",fileData); // 取得した内容の確認用
      ...
      reader.onload = function() {
         ...
         // result1.innerHTML =img.src;
         document.getElementById('console3').innerText="img uploaded..";

      }
      // ファイル読み込みを実行
      reader.readAsDataURL(fileData);
      
      document.getElementById('console3').innerText="classifier..";
